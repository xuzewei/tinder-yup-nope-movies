      ...
      return (
        <View style={styles.root}>
          <View style={styles.container}>
            <Text style={styles.getMovieText}>No movie liked yet!</Text>
          </View>
        </View>
      );
    }
    return (
      <View style={styles.root}>
        ...
        <View style={styles.getMeMovieContainer}>
          <TouchableWithoutFeedback onPress={() => Actions.moviesSimilar()}>
            <View style={styles.getMovieButton}>
              <Text style={styles.getMovieText}>Give me some movies</Text>
              <MaterialIcons
                name="local-movies"
                size={30}
